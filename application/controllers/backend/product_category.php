...
class product_category extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->model_name = 'product_category_model';
	...
	public function addItemForm()
	{
		...
		$this->parser->parse('backend_views/add_product_category_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_footer_view',$this->parser_data);
	}

	public function addItem()
	{
		$product_category_name_tr = $this->input->post('product_category_name_tr');
		$product_category_name_eng = $this->input->post('product_category_name_eng');
	...
	public function allItems()
	{
		...
		$this->parser->parse('backend_views/admin_header_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_main_view',$this->parser_data);
		$this->parser->parse('backend_views/all_product_category_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_footer_view',$this->parser_data);		
	}
	...
	public function updateItemDetailForm($id)
	{
		...
		$this->parser->parse('backend_views/admin_header_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_main_view',$this->parser_data);
		$this->parser->parse('backend_views/update_product_category_detail_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_footer_view',$this->parser_data);			
	}
	...
	public function updateItemDetail()
	{
		...
		$product_category_name_tr = $this->input->post('title_tr');
		$product_category_name_eng = $this->input->post('title_eng');
