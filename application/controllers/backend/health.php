...
class health extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->model_name = 'health_model';
		$this->item_big_photo_column_name = 'health_big_photo';
		$this->item_thumb_photo_column_name = 'health_thumb_photo';

		$this->change_item_photo_form_action = 'health/changeItemPhoto';
		...
		$this->img_lib_bootstrap_data = array(
											  ...
											  'upload_path'		 =>	'assets/images/health',
	...
	public function addItemForm() 
	{
		...
		$this->parser->parse('backend_views/add_health_view',$this->parser_data);
	...
	public function addItem()
	{
		...
		if (($health_title!='')) 
		{
			...
			if ($image_up_and_resize == TRUE) 
			{
				...
				$insert_item_detail_to_db = $this->{$this->model_name}->insertNewItemDetail($health_title);
	...
	public function allItems()
	{
		...
		$this->parser->parse('backend_views/admin_header_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_main_view',$this->parser_data);
		$this->parser->parse('backend_views/all_health_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_footer_view',$this->parser_data);		
	}
