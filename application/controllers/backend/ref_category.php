...
class ref_category extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->model_name = 'ref_category_model';
	...
	public function addItemForm()
	{
		...
		$this->parser->parse('backend_views/add_ref_category_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_footer_view',$this->parser_data);
	}

	public function addItem()
	{
		$ref_category_name_tr = $this->input->post('ref_category_name_tr');
		$ref_category_name_eng = $this->input->post('ref_category_name_eng');

		if (($ref_category_name_tr!='')&&($ref_category_name_eng!='')) 
		{
			$item_css = strtolower(filterForeignChars($ref_category_name_tr));	
			$insert_item_detail_to_db = $this->{$this->model_name}->insertNewItemDetail($ref_category_name_tr, $ref_category_name_eng, $item_css);
	...
	public function allItems()
	{
		...
		$this->parser->parse('backend_views/admin_header_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_main_view',$this->parser_data);
		$this->parser->parse('backend_views/all_ref_category_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_footer_view',$this->parser_data);		
	}
	...
	public function updateItemDetailForm($id)
	{
		...
		$this->parser->parse('backend_views/admin_header_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_main_view',$this->parser_data);
		$this->parser->parse('backend_views/update_ref_category_detail_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_footer_view',$this->parser_data);			
	}
	...
	public function updateItemDetail()
	{
		...
		$ref_category_name_tr = $this->input->post('title_tr');
		$ref_category_name_eng = $this->input->post('title_eng');

		if (($ref_category_name_tr!='')&&($ref_category_name_eng!='')) 
		{
			$item_css = strtolower(filterForeignChars($ref_category_name_tr));	
			$update_item_detail = $this->{$this->model_name}->updateItemDetail($item_id ,$ref_category_name_tr, $ref_category_name_eng, $item_css);
