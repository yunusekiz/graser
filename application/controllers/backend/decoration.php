...
class decoration extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->model_name = 'decoration_model';
		$this->item_big_photo_column_name = 'decoration_big_photo';
		$this->item_thumb_photo_column_name = 'decoration_thumb_photo';

		$this->change_item_photo_form_action = 'decoration/changeItemPhoto';
		...
		$this->img_lib_bootstrap_data = array(
											  ...
											  'upload_path'		 =>	'assets/images/decoration',
	...
	public function addItemForm() 
	{
		...
		$this->parser->parse('backend_views/add_decoration_view',$this->parser_data);
	...
	public function addItem()
	{
		...
		if (($decoration_title!='')) 
		{
			...
			if ($image_up_and_resize == TRUE) 
			{
				...
				$insert_item_detail_to_db = $this->{$this->model_name}->insertNewItemDetail($decoration_title);
	...
	public function allItems()
	{
		...
		$this->parser->parse('backend_views/admin_header_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_main_view',$this->parser_data);
		$this->parser->parse('backend_views/all_decoration_view',$this->parser_data);
		$this->parser->parse('backend_views/admin_footer_view',$this->parser_data);		
	}
