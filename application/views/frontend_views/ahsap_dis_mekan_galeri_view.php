...
<div id="header-wrapper">
    <div id="header">
        <div class="header-intro">
            <h1>Ahşap Dış Mekan Ürünleri Galeri</h1>
            <p>
                ahşap dış mekan ürünleri galeri
            </p>
...
<div id="content-wrapper">
    <div id="content">
        ...
        <div class="full-width">
            <ul class="work-list">
                {ahsap_mekan_galeri_iteration}
                <li style="width:180px;height:135px;margin-left:18px;margin-bottom:-5px;">
                    <a href="{base}{gal_out_big_photo}" rel="lightbox-work" title="{gal_out_title}">
                        <img src="{base}{gal_out_thumb_photo}" alt="" />
                    </a>
                    <div class="work-label"><a href="#">{gal_out_title}</a></div>
                </li>
                {/ahsap_mekan_galeri_iteration}                                                                                                                                                                     
            </ul>  
