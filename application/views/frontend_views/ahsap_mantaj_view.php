...
<div id="header-wrapper">
    <div id="header">
        <div class="header-intro">
            <h1>Uygulamalar - Ahşap Ürün Montajı </h1>
            <p>
                ahşap ürün montajı hizmetleri
            </p>
    ...
    <div id="content">
        ...
        <div id="inner-content">
            ...
            <div class="blog-block">
                <h2 class="kirmizi">Ahşap Ürün Montajı Hizmetleri</h2>
<!--                 <div class="blog-info">
                    <span>11th January 2010</span>&nbsp;&nbsp;|&nbsp;&nbsp;
                    <a href="#">showcases</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#">27 comments</a>
                </div> -->
                <h3>
                    Üretimini gerçekleştirdiğiniz ahşap ürünlerinize yönelik saha ve şantiye montaj hizmetleri, konusunda uzman ve deneyimli ekiplerimiz ile son derece hızlı ve kaliteden taviz vermeden gerçekleştirilmektedir.
                </h3>
                <h3>Montaj hizmeti verilen ürünler :</h3>

                 <div class="scontent-box">
                            <ul><br/>
                                <li>Ahşap İç kapı ve Pencereler
                                </li><br/><br/>
                                <li>Ahşap Dolaplar</li>
                                <br/><br/>

                                <li> Mutfak Dolapları </li> 
                                <br/><br/>

                                <li>Vestiyer ve Banyo Dolapları</li>
                                <br/><br/>

                                <li>
                                    Otel Dekorasyonu ve Mobilyası
                                </li>
                                <br/><br/>

                                <li>
                                    Spor ve İş Merkezleri Sabit ve hareketli dekorasyon ürünleri
                                </li>
                                <br/><br/>

                                <li>
                                    Lambri ve Deck döşemeleri
                                </li>
                                <br/><br/>

                                <li>
                                    Dış cephe kaplamaları, Fibercement, Ahşap yalıbaskı
                                </li>
                                <br/><br/>

                                <li>
                                    Ahşap Merdiven Kaplaması
                                </li>
                                <br/><br/>
                                ...
                                <li>
                                    Pergola, Kamelya, Gazebo ve Ahşap Kulübe 
                                </li><br/>
        ...
        <div id="sidebar">
             ...
             <div class="box">
                ...
                <div class="box-middle">
                    <ul class="box-list">
                        <li><a href="{base}uygulamalar/">Ahşap Kapı Sistemleri</a></li>
                        <li><a href="{base}uygulamalar/">Ahşap Dolap  Sistemleri</a></li>
                        <li><a href="{base}uygulamalar/">Ahşap Dekorasyon Ürünleri</a></li>    
                        <li  class="bl-active"><a href="{base}uygulamalar/">Ahşap Ürün Montajı</a></li>    
                        <li><a href="{base}uygulamalar/">Ahşap Dış Mekan Ürünleri</a></li>    
                        <li><a href="{base}uygulamalar/ahsap_ev">Ahşap Ev </a></li>                                                 
                    </ul>                   
                </div>
...
<!--             <div class="box">
        ...
        <div class="full-width">
            <ul class="work-list">
                {montaj_iteration}
                <li>
                    <a href="{base}{montage_big_photo}" rel="lightbox-work"><img src="{base}{montage_thumb_photo}" alt="" /></a>
                    <div class="work-label"><a href="#"></a></div>
                </li>
                {/montaj_iteration}                                                                                                                                                                     
            </ul>  
