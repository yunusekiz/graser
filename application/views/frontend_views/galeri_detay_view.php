...
<html>
	<head>
		...
		<style type="text/css">
		     .sol-menu ul li a:hover, .{gal_cat_css_switch}{background:url({base}img/sol-menu-li.png) no-repeat left top}
		</style>		
	</head>
    <body>
	<div class="ortala">
	...
	<div class="ortala">
		<div class="sol-menu">
			<ul id="galeri-menu">
				<li>
					<a href="{base}galeri">REFERANSLAR <span>REFERENCES</span></a>
				</li>
  	 ...
  	 <div id="wrapper">
    	 <div id="list">
      	  <div id="galeri">
        	 <div class="col1">
        	 {galeri_iteration}
        	   <div class="item"><a href="{base}{gal_big_photo}" rel="lightbox[roadtrip]" title="<h2>{title}</h2>{detail}"><img src="{base}{gal_thumb_photo}" ></a></div>
        	 {/galeri_iteration}
        	 </div>
