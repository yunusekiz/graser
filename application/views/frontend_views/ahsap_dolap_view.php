...
<div id="header-wrapper">
    <div id="header">
        <div class="header-intro">
            <h1>Uygulamalar - Ahşap Dolap Sistemleri </h1>
            <p>
                ahşap dolap sistemleri
            </p>
...
<div id="content-wrapper">
    <div id="content">
        ...
        <div id="inner-content">
            ...
            <div class="blog-block" style="margin-bottom:-500px;">
                <h2 class="kirmizi">Ahşap Dolap Sistemleri</h2>
                <br/><br/><br/>
<!--                 <div class="blog-info">
            ...
            <p style="font-weight:bold">
              Kuruluşumuz konut ve taahhüt projelerinin yanı sıra ahşap ev sistemleri, ahşap kapı ve dolap ile ahşap dekorasyon ürünleri üretim ve montajı alanında hizmet vermektedir.
                </p>
                </div> 
            </div>   
        ...
        <div id="sidebar">
             ...
             <div class="box">
                ...
                <div class="box-middle">
                    <ul class="box-list">
                        <li><a href="{base}uygulamalar/ahsap_kapi_sistemleri">Ahşap Kapı Sistemleri</a></li>
                        <li class="bl-active"><a href="{base}uygulamalar/">Ahşap Dolap  Sistemleri</a></li>
                        <li><a href="{base}uygulamalar/">Ahşap Dekorasyon Ürünleri</a></li>    
                        <li><a href="{base}uygulamalar/">Ahşap Ürün Montajı</a></li>    
...
<!--             <div class="box">
        ...
        <div class="full-width">
            <ul class="work-list">
                {dolap_iteration}
                <li>
                    <a href="{base}{closet_big_photo}" rel="lightbox-work"><img src="{base}{closet_thumb_photo}" alt="" /></a>
