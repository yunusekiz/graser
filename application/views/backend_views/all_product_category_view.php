			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3><font style="margin-left:270px;">Ürün Kategorisi (tüm kayıtlar)</font></h3>
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="{backend_base}product_category/updateItemDetailForm/{pro_cat_id}" title="Düzenle"><img src="{base}assets/backend_assets/images/icons/pencil.png" alt="Düzenle" /></a>
									</td>
