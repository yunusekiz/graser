			<div class="content-box"><!-- Start Content Box -->
			 	...
			 	<div class="content-box-header">
					<h3> <font style="margin-left:240px;">Ürün Kategorisi (kayıt güncelleme formu)</font></h3>
					<div class="clear"></div>
				  ...
				  <div class="content-box-content">	
					 ...
					 <div class="tab-content default-tab" id="1">
						...
						<form action="{base}backend/product_category/updateItemDetail" method="post" enctype="multipart/form-data">
							<br />
							...
							{item_detail}
								...
								<p>
									<input type="hidden" name="id" value="{pro_cat_id}"/>
