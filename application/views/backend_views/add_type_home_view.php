			<div class="content-box"><!-- Start Content Box -->
			 	...
			 	<div class="content-box-header">
					<h3> <font style="margin-left:240px;">Ahşap Ev Tipi Projeler - Yeni Kayıt Ekleme Formu</font></h3>
					<div class="clear"></div>
				  ...
				  <div class="content-box-content">	
					 ...
					 <div class="tab-content default-tab" id="1">
						...
						<form action="{base}backend/type_home/controlItem" method="post" enctype="multipart/form-data">
